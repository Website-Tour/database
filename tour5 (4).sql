...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th4 20, 2024 lúc 05:33 AM
...
(31, 'Bình Hưng', 'Tour Bình Hưng 3 ngày 2 đêm', 149, '2024-04-24', '2024-04-27', 'Cam Ranh, Nha Trang', 'Westside Vietnam', 'hinhhung1.jpg', 5, 5, 0, '', 'Võ Hoàng Yến', '0354770906', 'vominhson@gmail.com');
...
--
ALTER TABLE `tour`
  MODIFY `tourid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=32;
